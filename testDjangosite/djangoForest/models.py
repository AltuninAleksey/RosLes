...
class ListRegion(models.Model):
    ...
    id_district_forestly = models.ForeignKey("DistrictForestly", on_delete=models.CASCADE, verbose_name='Квартал', default= 2153)
...
class FieldCard(models.Model):
    ...
    stock = models.FloatField(verbose_name="Запас", null=True)

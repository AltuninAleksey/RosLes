...
class CZLSerializer(serializers.ModelSerializer):
    name_main_subject = serializers.CharField(source="id_main_subject.name_subject_RF", read_only = True)
...
class CZLSerializerWithOutMain(serializers.ModelSerializer):
    ...
    class Meta:
        model = CZL
        fields = ['name_slave_subject', 'id_subject']
...
class DescriptionRegionSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.recovery_method = validated_data.get('recovery_method')
        instance.save()
        return instance
...
class FieldCardSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.details_regulations = validated_data.get('details_regulations')
        instance.save()
        return instance
...
class ListFieldSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ListRegion
        fields = ['number_region', 'date', 'id_district_forestly', 'forestly', 'id_subject_rf', 'dacha', 'soil_lot', 'sample_region', 'name_quarter', 'id']

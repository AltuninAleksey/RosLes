...
function updateDataInDescriptionLandTbody(data) {
    ...
    for(var i = 0; i < data.length; i++) {
        ...
        newHtml = newHtml + `<tr class="cursorPointer" onClick=${strGetDescriptionLandDetail}>
                            ...
                            <td class="textAlignCenter cursorPointer"` +  "onClick='event.stopPropagation();downloadAllExcel(" + data[i].id_list_region + ");'>" +
                            ...
                            <td class="textAlignCenter cursorPointer"` +  "onClick='event.stopPropagation();deleteDescriptionLand(" + data[i].id + ");'>" +

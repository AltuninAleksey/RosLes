...
function addNewLineInGpsPoint() {
    ...
    for(var i = 0; i < APP.gpsTable.length; i++) {
         ...
         if(APP.delIdGpsPoint.includes(APP.gpsTable[i].id)) {
            continue;
        }

        var id_sample = document.getElementById("id_sample"+oldIndex).value;
        var latitude = document.getElementById("latitude"+oldIndex).value;
        var longitude = document.getElementById("longitude"+oldIndex).value;
    ...
    for(var i = 0; i < APP.countNewLineGpsPoint; i++) {

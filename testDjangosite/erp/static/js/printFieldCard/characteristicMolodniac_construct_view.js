...
async function deleteLinePoint7Table2Sapling(del_id) {

    APP.delIdList.push(del_id);

    var buffPoint7Table2Sapling = APP.point7Table2Sapling;
    APP.point7Table2Sapling = [];

    for(var i = 0; i < buffPoint7Table2Sapling.length; i++) {
        if(del_id != buffPoint7Table2Sapling[i].id_list) {
            APP.point7Table2Sapling.push(buffPoint7Table2Sapling[i]);
        }
    }
